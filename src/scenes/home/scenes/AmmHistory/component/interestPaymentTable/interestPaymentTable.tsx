...
import "./interestPaymentTable.scss";
import { Table, message, Select } from "antd";
import { getInterestPaymentHistories } from "service/http/http";
...
class InterestPaymentTable extends Component<
...
> {
    ...
    try {
      if (this.props.searchValue) {
        this.setState(
          ...
          () => {
            this.getInterestPaymentHistories();
          }
        );
      }
  ...
  render() {
    const columns = [
      ...
      {
        title: <FormattedMessage id="Interest Paid" />,
        dataIndex: "amount",
        key: "amount",
        render: (item: any) => item + " USD"
      },
      {
        title: <FormattedMessage id="Funding Rate" />,
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(injectIntl(InterestPaymentTable));
